...
// ── Session check ──────────────────────────────────────────────
// তোমার user session key অনুযায়ী adjust করো
if (!isset($_SESSION['user_id'])) {
    header("Location: login.html");
    exit;
}
$user_id   = (int)$_SESSION['user_id'];
$user_name = htmlspecialchars($_SESSION['user_name'] ?? 'Member');

// ── Registration table auto-create (না থাকলে বানিয়ে নেবে) ────
...
$upcoming = array_filter($events, fn($e) => strtotime($e['event_date']) >= strtotime(date('Y-m-d')));
$past     = array_filter($events, fn($e) => strtotime($e['event_date']) <  strtotime(date('Y-m-d')));
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card-title {
            ...
            color: white; line-height: 1.35; padding-top: 4px;
        }
        ...
        .event-desc {
            ...
            border-top: 1px solid #eef4f3; padding-top: 12px; margin-bottom: 16px; flex: 1;
        }
        ...
        .stat-pill {
            ...
            padding: 7px 16px; font-size: 0.87rem; font-weight: 600; color: #4a6260;
...
<div class="main-wrapper">
    ...
    <div class="content-body">
        ...
        <div class="stats-bar">
            ...
            <div class="stat-pill">✅ My Registrations <em><?= count(array_filter($events, fn($e) => $e['is_registered'])) ?></em></div>
        ...
        <div class="event-grid">
            ...
            <div class="event-card">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <div class="reg-count">👥 <?= $ev['total_registrations'] ?> member(s) registered</div>
        ...
        <div class="event-grid">
            ...
            <div class="event-card past-card">
                ...
                <div class="card-body">
                    ...
                    <div class="event-desc"><?= nl2br(htmlspecialchars($ev['description'])) ?></div>
                    <?php endif; ?>
                    <div class="reg-count">👥 <?= $ev['total_registrations'] ?> member(s) attended</div>
